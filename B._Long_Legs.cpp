...
void solve_single(){
    ll x,y;
    cin>>x>>y;
    map<pair<ll,pair<ll,ll> >,ll> mpt;
    queue<pair<ll,pair<ll,ll> > > q;
    q.push(mp(1,mp(0,0)));
    mpt[mp(1,mp(0,0))]=1;
    pair<ll,pair<ll,ll> > k;
    ll n=-1;
    while(!q.empty()){
        ll num=q.size();
        n++;
        for(ll i=0;i<num;i++){
            k=q.front();
            q.pop();
            cout<<k.first<<" "<<k.second.ff<<" "<<k.ss.ss<<nn;
            if(k.second.first==x && k.second.second==y){
                cout<<n<<nn;
                return;
            }
                if(k.second.first+k.first<=x){
                    if(mpt.count(mp(k.first,mp(k.second.first+k.first,k.second.second)))==0){
                        q.push(mp(k.first,mp(k.second.first+k.first,k.second.second)));
                        mpt[mp(k.first,mp(k.second.first+k.first,k.second.second))]=1;
                    }
                }
                if(k.second.second+k.first<=y){
                    if(mpt.count(mp(k.first,mp(k.second.first,k.second.second+k.first)))==0){
                        q.push(mp(k.first,mp(k.second.first,k.second.second+k.first)));
                        mpt[mp(k.first,mp(k.second.first,k.second.second+k.first))]=1;
                    }
                }
                if(k.first+1<=max(x,y)){
                    if(mpt.count(mp(k.first+1,mp(k.second.first,k.second.second)))==0){
                        q.push(mp(k.first+1,mp(k.second.first,k.second.second)));
                        mpt[mp(k.first+1,mp(k.second.first,k.second.second))]=1;
                    }
                }
        }
        cout<<nn;
