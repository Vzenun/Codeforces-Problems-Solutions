...
void solve_array(){
    ...
    if(arr[0]<0 && arr[1]<0 && flag==1){
    ...
    else if(arr[n-1]>0 && arr[n-2]>0 && flag==1){
        cout<<nope<<nn;
        return;
    }
    else if(arr[n-1]>0 && arr[0]<0 && flag==1 && arr[n-1]!=-arr[0]){
        cout<<nope<<nn;
        return;
    }
    else if(arr[n-1]>0 && arr[0]<0 && flag==1 && arr[n-1]==-arr[0]){
        ...
        if(n==3){
            if(arr[0]+arr[1]+arr[2]==arr[0] || arr[0]+arr[1]+arr[2]==arr[1] ||arr[0]+arr[1]+arr[2]==arr[2]){
                cout<<yup<<nn;
            }
            else{
                cout<<nope<<nn;
