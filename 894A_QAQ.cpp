...
ll qaq(ll a,string s,ll ** arr){
    ...
    if(s.size()==0){
        ...
        if(a==2){
            if(s[0]=='Q'){
                return arr[a][s.size()]=1+qaq(a,s.substr(1),arr);
            }
            else{
                return arr[a][s.size()]=qaq(a,s.substr(1),arr);
            }
        }
        else if(a==1){
            if(s[0]=='A'){
                return arr[a][s.size()]=qaq(a+1,s.substr(1),arr)+qaq(a,s.substr(1),arr);
            }
            else{
                return arr[a][s.size()]=qaq(a,s.substr(1),arr);
            }
